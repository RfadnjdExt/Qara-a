                ...
                upcomingSessions.map((session) => (
                  <Card key={session.id} className="p-4">
                    <div className="flex justify-between items-start">
                      ...
                      <span className="text-xs px-2 py-1 bg-blue-100 text-blue-700 rounded">Scheduled</span>
                    </div>
                  </Card>
                ))
              )}
      ...
      <TabsContent value="evaluations">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your latest Mutabaah evaluations</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-2 px-4">Tajweed</th>
                  </tr>
                </thead>
                <tbody>
